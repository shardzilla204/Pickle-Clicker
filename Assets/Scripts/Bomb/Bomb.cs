...
namespace PickleClicker.Game.Pickle
{
    public class Bomb : MonoBehaviour
    {
        ...
        public void SetUpCountdown()
        {
            ...
            BombTimer bombTimer = timerClone.GetComponent<BombTimer>();
            bombTimer.StartCountdown(timerClone);
        }
        ...
        private int CalculateDamage(NormalPoglin poglin)
        {
            ...
            UpgradeData bombDamage = bombCategory.upgrades.Find(upgrade => upgrade.id == 1);
        ...
        {
            UpgradeCategoryData bombCategory = PlayerData.upgradeCategoryDataList.Find(category => category.id == 3);
            UpgradeData bombRadius = bombCategory.upgrades.Find(upgrade => upgrade.id == 1);
